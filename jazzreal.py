...
#rechercher un pont
	...
	return render_template('query_results.html', results_artist=results_artist, results_title=results_title, results_cadence=results_cadence, results_bridge=results_bridge, results_versions=results_versions)
